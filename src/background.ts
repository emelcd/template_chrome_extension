...
const technologies: Technology[] = [
  ...
  },
  {
    ...
    features: ["Hot Reload", "Expressive and Flexible UI", "Native Performance"],
    popularity: 85,
  ...
  },
  {
    ...
    license: "Apache 2.0",
    platforms: ["Various"],
    features: ["Comprehensive ML", "Flexible Ecosystem", "Robust ML Production"],
    popularity: 80,
  ...
  },
  {
    ...
    license: "Apache 2.0",
    platforms: ["Various"],
    features: ["Automated Rollouts and Rollbacks", "Storage Orchestration", "Service Discovery and Load Balancing"],
    popularity: 85,
